 ...
 */
@RequestMapping("/deleterealestateuserproperty")
 ...
 */
public interface RealEstateDeleteUserPropertyController {

  //@formatter:off
  @Operation(
      summary = "Deletes a user property from the application",
      description = "Deletes a user property from the application",
      responses = {
          @ApiResponse(responseCode = "201", description = "The user property has been deleted", content = @Content(mediaType = "application/json", 
          ...
          @ApiResponse(responseCode = "404", description = "A user property with the parameter was not found", content = @Content(mediaType = "application/json")), // not found 
