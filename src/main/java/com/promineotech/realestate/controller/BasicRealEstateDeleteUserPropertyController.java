...
import com.promineotech.realestate.service.RealEstateDeleteUserPropertyService;
...
@RestController
@Slf4j
public class BasicRealEstateDeleteUserPropertyController implements RealEstateDeleteUserPropertyController {

  @Autowired
  private RealEstateDeleteUserPropertyService realEstateDeleteUserPropertyService;

  @Override
  public void deleteUserProperty(int propertyPK) {
    log.debug("propertyPK={}", propertyPK);
    realEstateDeleteUserPropertyService.deleteUserProperty(propertyPK);
  }
