 ...
 */
@RequestMapping("/createrealestateuser")
 ...
 */
public interface RealEstateCreateUserController {

  //@formatter:off
  @Operation(
      summary = "Create user for the application",
      description = "Returns a user for the application",
      responses = {
          @ApiResponse(responseCode = "201", description = "The user was created", content = @Content(mediaType = "application/json", 
...
//     
  ...
  Users saveUser(@RequestParam(required = false) String firstName, 
