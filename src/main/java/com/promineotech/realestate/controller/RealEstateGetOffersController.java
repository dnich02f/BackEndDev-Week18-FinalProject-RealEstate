 ...
 */
@RequestMapping("/getrealestateoffers")
 ...
 */
public interface RealEstateGetOffersController {

  //@formatter:off
  @Operation(
      summary = "Return a list of Real Estate Offers",
      description = "Returns a list of Real Estate Offers",
      responses = {
          @ApiResponse(responseCode = "200", description = "A list of Real Estate Offers is returned", content = @Content(mediaType = "application/json", 
          ...
          @ApiResponse(responseCode = "404", description = "No Real Estate Offers were found with the input criteria", content = @Content(mediaType = "application/json")), // not found 
...
//      ,
//      parameters = {
//          @Parameter(name = "firstName", allowEmptyValue = false, required = false, description = "Enter desired PropertyType (i.e., 'SINGLE_FAMILY', 'MULTI_FAMILY', 'COMMERCIAL')")
//      }
