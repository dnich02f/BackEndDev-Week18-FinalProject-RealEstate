package com.promineotech.realestate.errorhandler;
...
public class GlobalErrorHandler {
  ...
  private Map<String, Object> createExceptionMessage(Exception e, 
    ...
    /*
     * Cast webRequest interface to a ServletWebRequest Object
     */
  ...
  /*
   * Spring will intercept a NoSuchElementException, call the handleNoSuchElementException,
   * it will pass in the exception
   */
